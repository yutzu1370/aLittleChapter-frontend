      ...
      <section className="w-full overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" ref={carouselRef}>
          <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-stretch">
            {/* 左側圖片 */}
            <div className="w-full md:w-1/2 rounded-3xl overflow-hidden p-2 flex items-center justify-center h-full">
              <Image 
            ...
            {/* 右側內容 */}
            <div className="w-full md:w-1/2 bg-white rounded-3xl pt-7 px-7 pb-3 mt-2 flex flex-col justify-between border-[#F8D0B0] border-[6px] h-full">
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-6">
                  <h1 className="text-2xl sm:text-4xl font-jf-openhuninn text-emerald-800">親子共讀時光，從這裡開始</h1>
              ...
              <div className="flex justify-between items-center w-full mt-9">
                ...
                >
                  <ChevronLeft className="w-6 h-6 text-[#E8652B]" />
                </button>
                ...
                <button 
                  ...
                  className="bg-white border-2 border-[#E8652B] rounded-full shadow-[4px_6px_0px_#74281A] w-10 h-10 md:w-12 md:h-12 flex items-center justify-center hover:bg-[#FEF5EE] transition"
                >
                  <ChevronRight className="w-6 h-6 text-[#E8652B]" />
                </button>
              </div>
            </div>
          </div>
